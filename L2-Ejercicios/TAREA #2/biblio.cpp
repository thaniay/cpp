...
void cargarLibros() {
    // Arreglo con categoria y descripcion y autor
	libros[0][0] = "Algoritmos"; libros[0][1] = "Algoritmos y Programacion (Guia para docentes)";libros[0][2] = "Bill Gates";
	libros[1][0] = "Algoritmos"; libros[1][1] = "Apuntes de Algoritmos y Estructuras de Datos";libros[1][2] = "Steve McConell";
	libros[2][0] = "Algoritmos"; libros[2][1] = "Breves Notas sobre Analisis de Algoritmos";libros[2][2] = "Thomas H. Cormen";
	libros[3][0] = "Algoritmos"; libros[3][1] = "Fundamentos de Informatica y Programacion";libros[3][2] = " Charles E. Leiserson";
	libros[4][0] = "Algoritmos"; libros[4][1] = "Temas selectos de estructuras de datos";libros[4][2] = "Ronald L. Rivest";
	libros[5][0] = "Algoritmos"; libros[5][1] = "Teoria sintactico-gramatical de objetos";libros[5][2] = "Harold Abelson";
	...
	libros[24][0] = "PHP"; libros[24][1] = "PHP y Programacion orientada a objetos";libros[24][2] = "Eugenia Bahit";
	libros[25][0] = "PHP"; libros[25][1] = "POO y MVC en PHP";libros[25][2] = "Andrew McAvoy";
	libros[26][0] = "PHP"; libros[26][1] = "Silex, el manual oficial";libros[26][2] = "Steve Jobs";
	libros[27][0] = "PHP"; libros[27][1] = "Symfony 1.4, la guia definitiva";libros[27][2] = "Mark Zuckerberg";
	libros[28][0] = "PHP"; libros[28][1] = "Symfony 2.4, el libro oficial"; libros[28][2] = "Bill Gates";
	libros[29][0] = "Python"; libros[29][1] = "Aprenda a pensar como un programador (con Python)";libros[29][2] = "George Cooper";
	libros[30][0] = "Python"; libros[30][1] = "Doma de Serpientes para Ninos: Aprendiendo a Programar con Python";libros[30][2] = "Harold Abelson";
	libros[31][0] = "Python"; libros[31][1] = "Inmersion en Python";libros[31][2] = "Eduardo Garcia";
	libros[32][0] = "Python"; libros[32][1] = "Inmersion en Python 3";libros[32][2] = "Tania Piedy";
	libros[33][0] = "Python"; libros[33][1] = "Introduccion a la programacion con Python";libros[33][2] = "Eugenia Bahit";
	libros[34][0] = "Python"; libros[34][1] = "Introduccion a Programando con Python";libros[34][2] = "Ronald L. Rivest";
	libros[35][0] = "Python"; libros[35][1] = "Python instantaneo (1999)";libros[35][2] = "Raúl González Duque";
	libros[36][0] = "Python"; libros[36][1] = "Python para ciencia e ingenieria";libros[36][2] = "Charles R. Severance";
	libros[37][0] = "Python"; libros[37][1] = "Python para principiantes";libros[37][2] = "Eugenia Bahit";
	libros[38][0] = "Python"; libros[38][1] = "Python para todos";libros[38][2] = "Charles R. Severance";
}
